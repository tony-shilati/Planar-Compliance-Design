function [] = Synthesis5S()

addpath('PlanarComplianceApp/Parallel5SSynthesis/')
...
fig = figure(1); clf;
set(fig,'Name','Realization of a 5 Spring Parallel Mechanism','NumberTitle','on');
...
open_gde = uicontrol('Style', 'pushbutton', ...
    ...
    'Callback',{@UIcallback5S,0,'open_gde'});
...
table = uitable('units','normalized',...
            ...
            'CellEditCallback',{@UIcallback5S,ax,'c'},...
...
scalar = uicontrol('Style','edit','string','6',...
    ...
    'fontunits','normalized',...
    'fontsize', 0.5,...
    'position',[0.025 0.39 0.3 0.05],...
    'tag','dim',...
    'Callback',{@UIcallback5S,ax,'dim'});                   
...
rst = uicontrol('Style','pushbutton',...
    ...
    'tag','reset',...
    'value',0,...
    'Callback',{@UIcallback5S,ax,'reset'});
...
sbmt = uicontrol('Style', 'pushbutton', ...
    ...
    'FontUnits', 'normalized', ...
    'FontSize', 0.5, ...
    'Callback', {@UIcallback5S, ax, 'Submit'}); 
