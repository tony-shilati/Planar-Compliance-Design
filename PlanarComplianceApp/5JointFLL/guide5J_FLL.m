...
gdeData5J_FLL = guide_message;

gdeData5J_FLL.msg1 = ['  Welcome to the Five Joint Fixed Link Length Serial Mechanism Designer. ' ...
...
gdeData5J_FLL.msg2 = 'Select an arbitrary point on the graph or enter the coordinates of a point and press submit to define the location of the first joint.';

gdeData5J_FLL.msg3 = ['Select or enter the cordinates of a point on the blue line to define the first twist center. Once the first twist center is defined, the two possible locations of joint 2 will be plotted. Keep in mind that the first twist ' ...
            'center must be contained in the triangle defined by joint 3, joint 4, and joint 5.'];

gdeData5J_FLL.msg4 = 'Select one of the red points on the circle to be the location of the second joint.';

gdeData5J_FLL.msg5 = ['Select or enter the coordinates of a point near the line ' ...
            'segment between joint 1 and joint 2 that is outside of the blue quadratic curve. ' ...
            'This will be the location of teh second twist center. Keep in mind that the second twist center ' ...
            'must be contained in the triangle defined by joint 1, joint 2, and joint 5.'];

gdeData5J_FLL.msg6 = 'Select one of the red points on the circle to be the location of the third joint.';

gdeData5J_FLL.msg7 = 'Select one of the red points on the circle to be the location of the fifth joint.';

gdeData5J_FLL.msg8 = 'msg8';
...
next = uicontrol('Style', 'pushbutton', ...
    ...
    'Callback', {@guideCallback5J_FLL, 'Next', msg});
...
Previous = uicontrol('Style', 'pushbutton', ...
    ...
    'BackgroundColor', [1 1 1], ...
    'ForegroundColor', [0, 0, 0], ...
    'Callback', {@guideCallback5J_FLL, 'Previous', msg});
