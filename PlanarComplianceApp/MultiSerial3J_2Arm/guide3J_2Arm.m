...
gdeData3J_2Arm = guide_message;

gdeData3J_2Arm.msg1 = ['    Welcome to the Two, Three Joint Arm, Multiserial Mechanism Designer. ' ...
...
gdeData3J_2Arm.msg2 = 'Select or enter the coordinates of another point to define the location of the second twist center. The line of action of the third and fourth springs will intersect at this location.';

gdeData3J_2Arm.msg3 = 'Select or enter the coordinates of another point to define the line of action of the first spring. This line will pass through the selected point and the first twist center.';

gdeData3J_2Arm.msg4 = 'Select or enter the coordinates of another point to define the line of action of the second spring. This line will pass through the selected point and the first twist center.';

gdeData3J_2Arm.msg5 = 'Select or enter the coordinates of another point to define the line of action of the third spring. This line will pass through the selected point and the second twist center.';

gdeData3J_2Arm.msg6 = 'Select or enter the coordinates of another point to define the line of action of the fourth spring. This line will pass through the selected point and the second twist center.';

gdeData3J_2Arm.msg7 = ['Select or enter another point to define the third twist center. The lines of action of the fifth and sixth spring will intersect at this location. One of the lines of action of the fifth and sixth springs passing through the third twist center ' ...
...
gdeData3J_2Arm.msg8 = ['Select or enter the coordinates of another point to define the line of action of the fifth spring. ' ... 
    'This line will pass through the third twist center and the selected point.'];

gdeData3J_2Arm.msg9 = ['Select or enter the coordinates of another point to define the line of action of the sixth spring. ' ... 
    'This line will pass through the third twist center and the selected point. ' ...
...
gdeData3J_2Arm.msg10 = ['Before converting the mechanism, you must split the spring wrenches into groups of three. ' ...
    'Each group of three will be used to makeup one of the arms. Enter the groups in their respective boxes and press submit. '];

gdeData3J_2Arm.msg11 = ['The two, three joint arm, multiserial mechanism is now complete. ' ...
...
next = uicontrol('Style', 'pushbutton', ...
    ...
    'Callback', {@guideCallback3J_2Arm, 'Next', msg});
...
Previous = uicontrol('Style', 'pushbutton', ...
    ...
    'BackgroundColor', [1 1 1], ...
    'ForegroundColor', [0, 0, 0], ...
    'Callback', {@guideCallback3J_2Arm, 'Previous', msg});
