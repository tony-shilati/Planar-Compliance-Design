...
elseif phase == 11
    ...
    set(findobj(fig, 'Tag', 'g11'), 'Visible', 'on')
    set(findobj(fig, 'Tag', 'g12'), 'Visible', 'on')
    set(findobj(fig, 'Tag', 'g13'), 'Visible', 'on')
    set(findobj(fig, 'Tag', 'g21'), 'Visible', 'on')
    set(findobj(fig, 'Tag', 'g22'), 'Visible', 'on')
    set(findobj(fig, 'Tag', 'g23'), 'Visible', 'on')

    set(findobj(fig, 'Tag', 'grp1'), 'Visible', 'on')
    set(findobj(fig, 'Tag', 'grp2'), 'Visible', 'on')
