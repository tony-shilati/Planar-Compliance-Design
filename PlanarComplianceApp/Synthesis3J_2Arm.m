function [] = Synthesis3J_2Arm()
addpath('PlanarComplianceApp/MultiSerial3J_2Arm/')
...
fig = figure(1); clf;
set(fig,'Name','Realization of a 3 Joint, 2 Arm, Multiserial Mechanism','NumberTitle','on');
...
home = uicontrol('Style', 'pushbutton', ...
    ...
    'Callback',{@UICallback3J_2Arm,0,'Home'});
...
open_gde = uicontrol('Style', 'pushbutton', ...
    ...
    'Callback',{@UICallback3J_2Arm,0,'open_gde'});
...
table = uitable('units','normalized',...
            ...
            'CellEditCallback',{@UICallback3J_2Arm,ax,'c'},...
...
scalar = uicontrol('Style','edit','string','6',...
    ...
    'tag','dim',...
    'Callback',{@UICallback3J_2Arm,ax,'dim'});                   
...
rst = uicontrol('Style','pushbutton',...
    ...
    'tag','reset',...
    'value',0,...
    'Callback',{@UICallback3J_2Arm,ax,'reset'});
...
sbmt = uicontrol('Style', 'pushbutton', ...
    ...
    'FontUnits', 'normalized', ...
    'FontSize', 0.5, ...
    'Callback', {@UICallback3J_2Arm, ax, 'Submit'}); 
...
cvt = uicontrol('Style', 'pushbutton', ...
    ...
    'FontSize', 0.35, ...
    'Visible', 'off', ...
    'Callback', {@UICallback3J_2Arm, ax, 'cvt'});

%Creates a label for the point 1 inputs 
group1Lab = uicontrol('Style', 'text', ...
    'Parent', hp, ...
    'Units', 'normalized', ...
    'FontUnits', 'normalized', ...
...
%Creates a label for the point 2 inputs
group2Lab = uicontrol('Style', 'text', ...
    'Parent', hp, ...
    'Units', 'normalized', ...
    'FontUnits', 'normalized', ...
    'Position', [0.025 0.58 0.3 0.05], ...
...
g11 = uicontrol('Style', 'edit', ...
    'Parent', hp, ...
    'String', '', ...
    'Units', 'normalized', ...
    'FontUnits', 'normalized', ...
    'Position', [0.325 0.63 0.2 0.05], ...
    'Tag', 'g11', ...
    'Visible', 'off');

g12 = uicontrol('Style', 'edit', ...
    'Parent', hp, ...
    'String', '', ...
    'Units', 'normalized', ...
    'FontUnits', 'normalized', ...
    'Position', [0.53 0.63 0.2 0.05], ...
    'Tag', 'g12', ...
    'Visible', 'off');

g13 = uicontrol('Style', 'edit', ...
    'Parent', hp, ...
    'String', '', ...
    'Units', 'normalized', ...
    'FontUnits', 'normalized', ...
    'Position', [0.735 0.63 0.2 0.05], ...
    'Tag', 'g13', ...
    'Visible', 'off');

g21 = uicontrol('Style', 'edit', ...
    'Parent', hp, ...
    'String', '', ...
    'Units', 'normalized', ...
    'FontUnits', 'normalized', ...
    'Position', [0.325 0.58 0.2 0.05], ...
    'Tag', 'g21', ...
    'Visible', 'off');

g22 = uicontrol('Style', 'edit', ...
    'Parent', hp, ...
    'String', '', ...
    'Units', 'normalized', ...
    'FontUnits', 'normalized', ...
    'Position', [0.53 0.58 0.2 0.05], ...
    'Tag', 'g22', ...
    'Visible', 'off');

g33 = uicontrol('Style', 'edit', ...
    'Parent', hp, ...
    'String', '', ...
    'Units', 'normalized', ...
    'FontUnits', 'normalized', ...
    'Position', [0.735 0.58 0.2 0.05], ...
    'Tag', 'g23', ...
    'Visible', 'off');
